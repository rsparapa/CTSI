...
10:30& Hands-on with Jupyterhub: slides 19:24  \\
12:00& Lunch on your own \\
12:30& Hands-on with Jupyterhub: slides 25:31  \\
2:00 & Biological break \\
2:15 & Hands-on with Jupyterhub: slides 33:39 \\
3:45 & Q and A \\
...
\begin{frame}[fragile]\frametitle{\bf\textcolor{blue}{Cancer Research}}

\begin{itemize}
\item We have already mentioned NCI SEER
\item Another resource is NCI
...
\item However, this type of processing is very challenging with R
\item This is a job for ... \texttt{RASMACRO}!
...
a=proc.time()
med_name=dbGetQuery(db, "select distinct medication_name,
                         pharm_class, pharm_subclass, 
                         substring(gpi from 1 for 2) as gpi_group,
                         substring(gpi from 3 for 2) as gpi_class,
                         substring(gpi from 5 for 2) as gpi_subclass,
                         ingredient_rxcui_name
                         ...
                         ingredient_rxcui_name")
print(proc.time()-a)
write.csv(med_name, "med_name.csv", row.names=FALSE, na="")
